...
- **Multi-type Management**: Support for students, teachers, staff members, and visitors
- **Access Logs**: Complete history of all access attempts (success/failure)

### Person Management

- **Full CRUD**: Create, read, update, and delete persons
- **Person Types**: Students, teachers, staff members, visitors
...
- **Teachers and Staff Members**: Access always granted
